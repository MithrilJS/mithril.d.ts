...
;(function() {
	var ComponentWithInitialState: m.Comp<{}, {data: string}> = {
...
;(function() {
	var ComponentWithDynamicState: m.Comp<{text: string}, {data?: string}> = {
...
;(function() {
	var ComponentUsingThis: m.Comp<{text: string}, {data?: string}> = {
		oninit: function(vnode) {
...
;(function() {
	...
	var added = stream.combine(function(a: stream.Stream<number>, b: stream.Stream<number>) {
		return a() + b()
	}, [a, b])
